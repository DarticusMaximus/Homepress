...
**Status:** `0.1.5` is an **alpha** release — suitable for personal / lab use, not production hardening.
...
| Service | Image |
| --- | --- |
| web | `ghcr.io/darticusmaximus/homepress-web:0.1.5` |
| worker | `ghcr.io/darticusmaximus/homepress-worker:0.1.5` |

Also tagged `:0.1.5-alpha`, `:alpha`, and `:latest` (**linux/amd64** — typical Komodo/VPS hosts).
