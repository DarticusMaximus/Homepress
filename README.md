...
Self-host web + worker against your own Appwrite. **`0.1.6` is alpha** — personal/lab use, not production.
...
Images: `ghcr.io/darticusmaximus/homepress-web:0.1.6` and `ghcr.io/darticusmaximus/homepress-worker:0.1.6`. Runtime `.env` configures Appwrite — no rebuild when you change endpoint/project.
