...
export default async function NewslettersPage({ searchParams }: NewslettersPageProps) {
  ...
  if (total > 0 && requestedPage > totalPages) {
    redirect(totalPages === 1 ? "/admin/newsletters" : `/admin/newsletters?page=${totalPages}`);
  }
